...
// 			if (req.readyState === 4) {
// 				createItems(JSON.parse(req.responseText).businesses);
// 			}
// 		};

// 		// open will initiate the request to a specific endpoint with a HTTP verb (GET, POST, PUT, PATCH, DELETE)
// 		req.open('GET', 'https://api.yelp.com/v2/search/?term=vegetarian&location=charleston, sc&limit=10&radius_filter=4086&category_filter=newamerican');

// 		// Optionally takes some data to send with the request, like form data or json data
// 		req.send(null);
...
function yelpSearch(location, term, callback) {
    var method = 'GET';
